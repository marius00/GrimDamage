...
InventorySack_AddItem::GameInfo_SetModName_01 InventorySack_AddItem::dll_GameInfo_SetModName_01;
InventorySack_AddItem::GameInfo_SetModName_02 InventorySack_AddItem::dll_GameInfo_SetModName_02;
...
bool InventorySack_AddItem::m_hasModName;
#endif
...
#if MOD_FUNCTIONALITY_ENABLED
	dll_GameInfo_SetModName_01 = (GameInfo_SetModName_01)GetProcAddress(::GetModuleHandle("Engine.dll"), "?SetModName@GameInfo@GAME@@QAEXABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@@Z");
	DetourTransactionBegin();
	DetourUpdateThread(GetCurrentThread());
	DetourAttach((PVOID*)&dll_GameInfo_SetModName_01, Hooked_GameInfo_SetModName_01);
	DetourTransactionCommit();

	dll_GameInfo_SetModName_02 = (GameInfo_SetModName_02)GetProcAddress(::GetModuleHandle("Engine.dll"), "?SetModName@GameInfo@GAME@@QAEXABV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@std@@@Z");
	DetourTransactionBegin();
	DetourUpdateThread(GetCurrentThread());
	DetourAttach((PVOID*)&dll_GameInfo_SetModName_02, Hooked_GameInfo_SetModName_02);
	DetourTransactionCommit();
#endif
...
void* __fastcall InventorySack_AddItem::Hooked_InventorySack_AddItem_01(void* This, void* notUsed, void* item, bool findPosition, bool SkipPlaySound) {
	if (INSTALOOT_ENABLED) {
		...
		if (stash == STASH_4 && CanTransferItems()) {
...
#if MOD_FUNCTIONALITY_ENABLED
DataItemPtr InventorySack_AddItem::GetModName(void* This) {
	char* modName = dll_GameInfo_GetModName(This);
...
void* __fastcall InventorySack_AddItem::Hooked_InventorySack_InventorySackParam(void* This, void* Other) {
	...
	m_dataQueue->push(DataItemPtr(new DataItem(50002, 0, NULL))); SetEvent(m_hEvent);
...
void* __fastcall InventorySack_AddItem::Hooked_InventorySack_InventorySack(void* This) {
	...
	m_dataQueue->push(DataItemPtr(new DataItem(50003, 0, NULL))); SetEvent(m_hEvent);
...
int* __fastcall InventorySack_AddItem::Hooked_GameEngine_GetTransferSack(void* This, void* discarded, int idx) {
	if (idx == STASH_PRIVATE || idx == STASH_1 || idx == STASH_2 || idx == STASH_3 || idx == STASH_4) {
